        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-600 mb-8 font-inter">
              Download our free PDF guide with proven strategies for home service businesses
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-xl max-w-2xl mx-auto">
            <div className="mb-8">
              ...
              <div className="bg-gradient-to-r from-purple-100 to-blue-100 rounded-xl p-6 mb-6">
                ...
                <p className="text-gray-600">
                  A comprehensive guide with actionable strategies used by successful contractors
                </p>
              </div>
            </div>
            ...
            <p className="text-sm text-gray-500 mt-4">
              No spam. Just proven tips trusted by 500+ home service professionals.
            </p>
          </div>
        </div>
      </div>
