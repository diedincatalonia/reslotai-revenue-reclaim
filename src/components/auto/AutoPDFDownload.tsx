            ...
            <div className="mb-8">
              ...
              <div className="bg-gradient-to-r from-purple-100 to-blue-100 rounded-xl p-6 mb-6">
                <h4 className="text-xl font-semibold text-gray-800 mb-2">
                  "How to Reduce Cancellations for Auto Shops, Body Shops & Sales Departments"
                </h4>
                <p className="text-gray-600">
                  A comprehensive guide with actionable strategies used by successful automotive businesses
                </p>
              </div>
            </div>
