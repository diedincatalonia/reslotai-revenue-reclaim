        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-200 font-inter">
              See how much revenue you could recover from therapy session cancellations
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm mb-6">
                    ...
                    Click on any price or service name to edit it. Add your most common therapy sessions and their typical cancellation rates.
                  </p>
                </div>
