        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 animate-slide-up font-inter">
              ReslotAI automatically reschedules cancelled dental appointments and fills your chair time with zero extra work.
            </p>
            ...
            <div className="animate-slide-up">
              <p className="text-gray-300 text-sm mb-4 font-inter">Trusted by 200+ dental practices</p>
              <div className="flex flex-wrap justify-center lg:justify-start items-center gap-6 opacity-60">
                {['Smile Dental', 'OrthoMax', 'Premier Dentistry', 'Bright Smiles'].map((company, index) => (
