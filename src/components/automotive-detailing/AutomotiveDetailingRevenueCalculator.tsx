              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    💡 Tip: After adding a service, you can click on the price to customize it for your detailing business.
                  </p>
                </div>
              </div>
...
export default AutomotiveDetailingRevenueCalculator;
