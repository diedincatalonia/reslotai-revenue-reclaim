...
const BeautyRevenueCalculator = () => {
  ...
  const [newServiceType, setNewServiceType] = useState('haircut');

  const services = {
    haircut: { name: 'Haircut & Style', price: 65 },
    color: { name: 'Hair Color', price: 120 },
    highlights: { name: 'Highlights', price: 150 },
    blowout: { name: 'Blowout', price: 45 },
    manicure: { name: 'Manicure', price: 35 },
    pedicure: { name: 'Pedicure', price: 50 },
    facial: { name: 'Facial Treatment', price: 85 },
    massage: { name: 'Massage', price: 90 },
    eyebrows: { name: 'Eyebrow Shaping', price: 25 },
    extensions: { name: 'Hair Extensions', price: 200 },
    wedding: { name: 'Wedding Package', price: 300 }
  };
