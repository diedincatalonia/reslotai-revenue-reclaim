        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 animate-slide-up font-inter">
              ReslotAI automatically rebooks cancellations and fills your appointment book with zero extra work.
            </p>
            ...
            <div className="animate-slide-up">
              <p className="text-gray-300 text-sm mb-4 font-inter">Trusted by 200+ beauty professionals</p>
              <div className="flex flex-wrap justify-center lg:justify-start items-center gap-6 opacity-60">
                {['Luxe Salon', 'Style Studio', 'Nail Artistry', 'The Barbershop'].map((company, index) => (
              ...
              <div className="bg-white rounded-xl p-6 shadow-xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                    ...
                    <span className="font-bold text-purple-600">89 reviews</span>
                  </div>
                </div>
              </div>
            </div>
