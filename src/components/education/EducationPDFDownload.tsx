        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 font-inter">
              Want to Reduce Student No-Shows Like a Pro?
            </h2>
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-xl max-w-2xl mx-auto">
            <div className="mb-8">
              ...
              <div className="bg-gradient-to-r from-purple-100 to-blue-100 rounded-xl p-6 mb-6">
                <h4 className="text-xl font-semibold text-gray-800 mb-2">
                  "How to Reduce Cancellations for Education Providers"
                </h4>
                <p className="text-gray-600">
                  A comprehensive guide with actionable strategies used by successful education businesses
                </p>
              </div>
            </div>
            ...
            <p className="text-sm text-gray-500 mt-4">
              No spam. Just proven tips trusted by 150+ education professionals.
            </p>
          </div>
        </div>
      </div>
...
export default EducationPDFDownload;
