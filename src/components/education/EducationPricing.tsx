  ...
  const plans = [
    {
      name: 'Starter',
      price: 50,
      description: 'Perfect for small tutoring centers and independent educators',
      features: [
        '1 user seat',
        '100 students',
    ...
    },
    {
      name: 'Growth',
      price: 100,
      description: 'Ideal for growing education businesses',
      features: [
        'Unlimited seats',
        '2,000 students',
        'Automated email & SMS recovery',
    ...
    },
    {
      name: 'Pro',
      price: 150,
      description: 'For established institutions with high volume',
      features: [
        'Unlimited seats and students',
        'Automated email & SMS recovery',
        'Smart surveys',
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 font-inter">
            Flexible Plans Built for Every Education Provider
          </h2>
          <div className="bg-green-100 border border-green-300 rounded-lg p-4 max-w-2xl mx-auto mb-8">
            <p className="text-green-800 font-semibold">
              💡 Recover just 1 cancelled session per month and your plan pays for itself.
            </p>
          </div>
        </div>
