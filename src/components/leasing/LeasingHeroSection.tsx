        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 animate-slide-up font-inter">
              ReslotAI automatically reschedules cancelled apartment tours and fills your leasing calendar with zero extra work.
            </p>
            ...
            <div className="animate-slide-up">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start items-center gap-6 opacity-60">
                {['Skyline Apartments', 'Metro Living', 'Park View Complex', 'Urban Heights'].map((company, index) => (
