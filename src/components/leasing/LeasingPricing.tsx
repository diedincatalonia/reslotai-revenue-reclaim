  ...
  const plans = [
    {
      ...
      monthlyPrice: 89,
      annualPrice: 890,
      description: 'Perfect for individual apartment communities',
      features: [
        'Up to 8 leasing agents',
        '1,500 prospects',
    ...
    },
    {
      ...
      monthlyPrice: 349,
      annualPrice: 3490,
      description: 'For large property management groups',
      features: [
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Often costs less than a single recovered lease
          </p>
