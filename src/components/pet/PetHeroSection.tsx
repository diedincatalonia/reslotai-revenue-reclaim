        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 animate-slide-up font-inter">
              ReslotAI automatically reschedules cancelled pet grooming and vet appointments, keeping your clinic running smoothly.
            </p>
            ...
            <div className="animate-slide-up">
              <p className="text-gray-300 text-sm mb-4 font-inter">Trusted by 200+ pet care professionals</p>
              <div className="flex flex-wrap justify-center lg:justify-start items-center gap-6 opacity-60">
                {['Pawsome Grooming', 'VetCare Plus', 'Happy Tails Spa', 'Furry Friends Clinic'].map((company, index) => (
              ...
              <div className="bg-white rounded-xl p-6 shadow-xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                    <span className="text-sm text-gray-700">Pet Owner Response Rate</span>
                    <span className="font-bold text-blue-600">84%</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                    <span className="text-sm text-gray-700">Clinic Utilization</span>
