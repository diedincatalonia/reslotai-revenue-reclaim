      ...
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl lg:text-2xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join 200+ pet care professionals already recovering thousands in lost revenue every month
          </p>
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 mb-8 border border-white/30">
            <div className="flex items-center justify-center gap-3">
              ...
              <span className="text-lg font-semibold">Limited Time: Use code <span className="bg-yellow-300 text-blue-900 px-2 py-1 rounded font-bold">PAWS</span> for 10% off your first month!</span>
            </div>
          </div>
          ...
          <div className="text-blue-200 text-sm">
            ✓ No contracts required ✓ No setup fees ✓ Pet care industry compliant ✓ 24/7 support
          </div>
        </div>
      </div>
    </section>
