...
const GeneralMedicineTestimonials = () => {
  const testimonials = [
    {
      rating: 5,
      text: "We recovered $12,600 in one month alone!",
      author: "Dr. Rachel Johnson",
      title: "Family Medicine",
      business: "Westside Family Care",
      image: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=300&h=300&fit=crop&crop=face"
    },
    {
      rating: 5,
      text: "ReslotAI cut our no-show rate by 52% — patients love the flexible rebooking.",
    ...
    {
      rating: 5,
      text: "Setup was incredibly easy. It's automatically rebooking cancelled check-ups.",
      author: "Maria Rodriguez",
      title: "Practice Manager",
      business: "Community Health Clinic",
      image: "https://images.unsplash.com/photo-1594824388637-0d72c8c2d826?w=300&h=300&fit=crop&crop=face"
    }
  ];
    ...
    <section className="py-20 bg-gradient-hero">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-200">Trusted by 400+ medical practices</p>
        </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 max-w-md mx-auto">
            ...
            <p className="text-gray-200 text-sm">Based on 400+ verified reviews</p>
          </div>
        </div>
      </div>
    </section>
...
export default GeneralMedicineTestimonials;
