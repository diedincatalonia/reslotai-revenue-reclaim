  ...
  const plans = [
    {
      ...
      monthlyPrice: 75,
      annualPrice: 750,
      description: 'Perfect for single physician practices',
      features: [
        '1 provider',
        '500 patients',
    ...
    },
    {
      ...
      monthlyPrice: 250,
      annualPrice: 2500,
      description: 'For medical centers and large practices',
      features: [
        'Unlimited providers',
        'Unlimited patients',
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Often costs less than a single recovered consultation appointment
          </p>
...
export default GeneralMedicinePricing;
