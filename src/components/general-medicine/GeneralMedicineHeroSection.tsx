...
const GeneralMedicineHeroSection = () => {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 animate-slide-up font-inter">
              ReslotAI automatically reschedules cancelled medical appointments and fills your schedule with zero extra work.
            </p>
            ...
            <div className="animate-slide-up">
              <p className="text-gray-300 text-sm mb-4 font-inter">Trusted by 400+ medical practices</p>
              <div className="flex flex-wrap justify-center lg:justify-start items-center gap-6 opacity-60">
                {['Family Care', 'Medical Center', 'Health Clinic', 'Primary Care'].map((company, index) => (
              ...
              <div className="bg-white rounded-xl p-6 shadow-xl">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                    ...
                    <span className="font-bold text-green-600">63 this month</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                    <span className="text-sm text-gray-700">Patient Response Rate</span>
                    <span className="font-bold text-blue-600">79%</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                    <span className="text-sm text-gray-700">Schedule Utilization</span>
...
export default GeneralMedicineHeroSection;
