...
const GeneralMedicineRevenueCalculator = () => {
  const [services, setServices] = useState([
    { name: 'Office Visit', price: 200, cancellations: 12 },
    { name: 'Physical Exam', price: 350, cancellations: 8 }
  ]);

  const presetServices = [
    { name: 'Office Visit', price: 200 },
    { name: 'Physical Exam', price: 350 },
    { name: 'Consultation', price: 250 },
    { name: 'Follow-up Visit', price: 150 },
    { name: 'Immunization', price: 100 },
    { name: 'Lab Work', price: 180 },
    { name: 'Minor Procedure', price: 400 }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-200 font-inter">
              See how much revenue you could recover from medical appointment cancellations
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm mb-6">
                    ...
                    Click on any price or service name to edit it. Add your most common procedures and their typical cancellation rates.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    💡 Tip: After adding a service, you can click on the price to customize it for your practice.
                  </p>
                </div>
              </div>
...
export default GeneralMedicineRevenueCalculator;
