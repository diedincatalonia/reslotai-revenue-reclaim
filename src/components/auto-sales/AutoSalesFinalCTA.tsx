      ...
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl lg:text-2xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join 250+ auto dealerships already recovering thousands in lost revenue every month
          </p>
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 mb-8 border border-white/30">
            <div className="flex items-center justify-center gap-3">
              ...
              <span className="text-lg font-semibold">Limited Time: Use code <span className="bg-yellow-300 text-blue-900 px-2 py-1 rounded font-bold">SALES</span> for 10% off your first month!</span>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              ...
              <p className="text-blue-100">74% average recovery rate</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
          ...
          <div className="text-blue-200 text-sm">
            ✓ No setup fees ✓ No contracts required ✓ CRM compliant ✓ 24/7 support
          </div>
        </div>
      </div>
    </section>
...
export default AutoSalesFinalCTA;
