...
const AutoSalesTestimonials = () => {
  const testimonials = [
    {
      rating: 5,
      text: "We recovered $18,500 in sales commissions in one month alone!",
      author: "Marcus Johnson",
      title: "Sales Manager",
      business: "Premium Auto Dealership",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=300&fit=crop&crop=face"
    },
    {
      rating: 5,
      text: "ReslotAI cut our no-show rate by 45% — customers love the quick response.",
      author: "Jennifer Walsh",
      title: "BDC Director", 
      business: "Metro Car Sales",
      image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=300&h=300&fit=crop&crop=face"
    },
    {
      rating: 5,
      text: "Setup was incredibly easy. It's automatically rebooking cancelled test drives.",
      author: "Robert Chen",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-inter">
            What Auto Sales Professionals Say
          </h2>
          ...
          <p className="text-lg text-gray-200">Trusted by 250+ auto dealerships</p>
        </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 max-w-md mx-auto">
            ...
            <p className="text-gray-200 text-sm">Based on 250+ verified reviews</p>
          </div>
        </div>
      </div>
    </section>
...
export default AutoSalesTestimonials;
