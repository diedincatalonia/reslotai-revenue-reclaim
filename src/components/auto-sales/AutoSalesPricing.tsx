  ...
  const plans = [
    {
      ...
      monthlyPrice: 99,
      annualPrice: 990,
      description: 'Perfect for single dealership locations',
      features: [
        'Up to 10 sales reps',
        '2,000 customers',
    ...
    },
    {
      ...
      monthlyPrice: 199,
      annualPrice: 1990,
      description: 'Ideal for dealership groups',
      features: [
    ...
    },
    {
      ...
      monthlyPrice: 399,
      annualPrice: 3990,
      description: 'For large automotive groups',
      features: [
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Often costs less than a single recovered car sale
          </p>
...
export default AutoSalesPricing;
